...
import com.quanxiaoha.framework.common.constant.enums.DeletedEnum;
import com.quanxiaoha.framework.common.constant.enums.StatusEnum;
...
import com.quanxiaoha.xiaohashu.user.biz.domain.mapper.UserRoleRelDOMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public Response<?> updateUserInfo(UpdateUserInfoReqVO updateUserInfoReqVO) {
        ...
        if (needUpdate) {
            ...
            log.info("==> 准备更新用户信息，用户ID: {}, 更新内容: {}", userId, userDO);
   ...
   log.info("==> 用户是否注册，phone：{}，user DO：{}",phone, JsonUtils.toJsonString(userDO1));
